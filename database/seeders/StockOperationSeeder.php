    ...
    public function run(): void
    {
        ...
        */
        $adjustment = StockAdjustment::create([
            ...
            'adjustment_no' => DocumentNumber::make(StockAdjustment::class, 'adjustment_no', 'SA', $branch),
        ...
        */
        $transfer = StockTransfer::create([
            ...
            'transfer_no' => DocumentNumber::make(StockTransfer::class, 'transfer_no', 'ST', $branch),
