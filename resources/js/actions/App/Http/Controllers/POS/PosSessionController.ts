 ...
 * @see app/Http/Controllers/POS/PosSessionController.php:16
 * @route '/pos-sessions'
 */
 ...
 * @see app/Http/Controllers/POS/PosSessionController.php:45
 ...
 * @see app/Http/Controllers/POS/PosSessionController.php:118
 * @route '/pos-sessions/{posSession}/close'
 */
export const close = (
    args:
        | { posSession: number | { id: number } }
        | [posSession: number | { id: number }]
        | number
        | { id: number },
