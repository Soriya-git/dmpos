 ...
 */
const redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/features/navigation/url-fragments/redirect-hash'
 */
redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.url = (
    options?: RouteQueryOptions,
) => {
    return (
        redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.definition.url +
        queryParams(options)
    );
};
 ...
 * @route '/features/navigation/url-fragments/redirect-hash'
 */
redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.url(options),
    method: 'get',
 ...
 * @route '/features/navigation/url-fragments/redirect-hash'
 */
redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.head = (
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.url(options),
    method: 'head',
 ...
 * @route '/features/navigation/url-fragments/redirect-hash'
 */
redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb.url(options),
    method: 'post',
...
export const redirectWithHash = {
    '/features/navigation/url-fragments/redirect-hash':
        redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb,
    '/features/navigation/url-fragments/redirect-hash':
        redirectWithHashbcb5fb98bc39864b0a79594cd2a974cb,
};
