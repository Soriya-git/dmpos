 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/MasterData/CompanyBranchController.php:62
 * @route "http://localhost/master-data/company-branches/branches/{branch}"
 */
...
updateBranch.definition = {
    methods: ['post'],
    url: 'http://localhost/master-data/company-branches/branches/{branch}',
