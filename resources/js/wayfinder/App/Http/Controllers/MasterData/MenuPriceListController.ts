 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/MasterData/MenuPriceListController.php:92
 * @route "http://localhost/master-data/menu-price-lists"
 */
export const store = (
    options?: RouteQueryOptions,
 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/MasterData/MenuPriceListController.php:134
 * @route "http://localhost/master-data/menu-price-lists/{priceList}"
 */
export const update = (
    args:
...
update.definition = {
    methods: ['patch'],
    url: 'http://localhost/master-data/menu-price-lists/{priceList}',
