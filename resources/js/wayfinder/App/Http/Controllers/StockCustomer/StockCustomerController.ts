 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:28
 * @route "http://127.0.0.1:8000/stock-customer"
 */
...
index.definition = {
    methods: ["get","head"],
    url: "http://127.0.0.1:8000/stock-customer",
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:72
 * @route "http://127.0.0.1:8000/stock-customer/create"
 */
...
create.definition = {
    methods: ["get","head"],
    url: "http://127.0.0.1:8000/stock-customer/create",
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:105
 * @route "http://127.0.0.1:8000/stock-customer"
 */
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:150
 * @route "http://127.0.0.1:8000/stock-customer/{stockTransfer}"
 */
...
update.definition = {
    methods: ["patch"],
    url: "http://127.0.0.1:8000/stock-customer/{stockTransfer}",
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:187
 * @route "http://127.0.0.1:8000/stock-customer/{stockTransfer}/approve"
 */
...
approve.definition = {
    methods: ["patch"],
    url: "http://127.0.0.1:8000/stock-customer/{stockTransfer}/approve",
} satisfies RouteDefinition<["patch"]>
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:286
 * @route "http://127.0.0.1:8000/stock-customer/{stockTransfer}/reject"
 */
...
reject.definition = {
    methods: ["patch"],
    url: "http://127.0.0.1:8000/stock-customer/{stockTransfer}/reject",
} satisfies RouteDefinition<["patch"]>
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:301
 * @route "http://127.0.0.1:8000/stock-customer/{stockTransfer}/cancel"
 */
...
cancel.definition = {
    methods: ["patch"],
    url: "http://127.0.0.1:8000/stock-customer/{stockTransfer}/cancel",
} satisfies RouteDefinition<["patch"]>
 ...
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:63
 * @route "http://127.0.0.1:8000/stock-customer/invoices"
 */
...
invoices.definition = {
    methods: ["get","head"],
    url: "http://127.0.0.1:8000/stock-customer/invoices",
} satisfies RouteDefinition<["get","head"]>
...
/**
 * @see \App\Http\Controllers\StockCustomer\StockCustomerController::item
 * @see \D:\Lar\dmpos\app\Http\Controllers\StockCustomer\StockCustomerController.php:316
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
export const item = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<"get"> => ({
...
item.definition = {
    methods: ["get","head"],
    url: "http://127.0.0.1:8000/stock-customer/items/{item}",
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
item.url = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === "string" || typeof args === "number") {
    args = { item: args }
}
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
item.get = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<"get"> => ({
    url: item.url(args, options),
    method: "get",
})
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
item.head = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<"head"> => ({
    url: item.url(args, options),
    method: "head",
})
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
const itemForm = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<"get"> => ({
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
itemForm.get = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<"get"> => ({
    action: item.url(args, options),
    method: "get",
})
 ...
 * @route "http://127.0.0.1:8000/stock-customer/items/{item}"
 */
itemForm.head = (args: { item: number | { id: number } } | [ item: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<"get"> => ({
    action: item.url(args, formSafeOptions("head", options)),
    method: "get",
})
...
export default StockCustomerController