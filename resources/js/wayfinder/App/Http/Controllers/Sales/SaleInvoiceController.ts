 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/Sales/SaleInvoiceController.php:23
 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/Sales/SaleInvoiceController.php:93
 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/Sales/SaleInvoiceController.php:233
 * @route "http://localhost/sales/invoices/{invoice}/cancel"
 */
export const cancel = (
    args:
        | { invoice: number | { id: number } }
...
cancel.definition = {
    methods: ['patch'],
    url: 'http://localhost/sales/invoices/{invoice}/cancel',
 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/Sales/SaleInvoiceController.php:333
 * @route "http://localhost/sales/invoices/{invoice}/receipts/cancel"
 */
export const cancelInvoicePayments = (
    args:
        | { invoice: number | { id: number } }
        | [invoice: number | { id: number }]
        | number
...
cancelInvoicePayments.definition = {
    methods: ['patch'],
    url: 'http://localhost/sales/invoices/{invoice}/receipts/cancel',
} satisfies RouteDefinition<['patch']>;
...
cancelInvoicePayments.url = (
    ...
    return (
        cancelInvoicePayments.definition.url
            .replace('{invoice}', parsedArgs.invoice.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route "http://localhost/sales/invoices/{invoice}/receipts/cancel"
 */
const cancelInvoicePaymentsForm = (
    args:
        | { invoice: number | { id: number } }
        | [invoice: number | { id: number }]
        | number
 ...
 * @route "http://localhost/sales/invoices/{invoice}/receipts/cancel"
 */
cancelInvoicePaymentsForm.patch = (
    args:
        | { invoice: number | { id: number } }
        | [invoice: number | { id: number }]
        | number
 ...
 * @see /home/runner/work/dmpos/dmpos/app/Http/Controllers/Sales/SaleInvoiceController.php:291
 * @route "http://localhost/sales/payments/{payment}/cancel"
 */
...
cancelPayment.definition = {
    methods: ['patch'],
    url: 'http://localhost/sales/payments/{payment}/cancel',
} satisfies RouteDefinition<['patch']>;
