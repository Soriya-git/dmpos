                ...
                >
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-1 text-xl font-bold text-[#2a4858]">
                                {{ detailAdjustment.code }}
                            </h2>
                            <p class="mt-1 text-sm text-slate-500">
                                {{ typeLabel(detailAdjustment.type) }} /
                                {{ detailAdjustment.warehouse }}
                            </p>
                        </div>
                        <Button
                            type="button"
                    ...
                    <div class="min-h-0 flex-1 overflow-y-auto p-5">
                        <div class="mb-4 grid gap-3 text-sm sm:grid-cols-3">
                            ...
                            <div class="rounded-lg bg-slate-50 p-3">
                                ...
                                <span
                                    ...
                                    :class="
                                        statusClass(detailAdjustment.status)
                                    "
                                >
                                    {{ statusLabel(detailAdjustment.status) }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left text-sm">
                                ...
                                <tbody>
                                    <tr
                                        v-for="line in detailAdjustment.lines"
                                        :key="line.id"
                    ...
                    >
                        ...
                        >
                            ...
                            {{ detailAdjustment.lines.length }} item line{{
                                detailAdjustment.lines.length === 1 ? '' : 's'
                            }}
                        </div>
                        <div class="text-right">
                            ...
                            <p class="text-xl font-bold text-[#007882]">
                                {{ money(detailAdjustment.totalCost) }}
                            </p>
                        </div>
                    </footer>
                </section>
