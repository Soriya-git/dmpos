...
type MenuView = 'all' | 'confirmed' | 'invoiced' | 'paid' | 'pending';
...
const activeView = ref<MenuView>('all');
const search = ref('');
...
const tabs: {
    ...
    { key: 'all', label: 'All Menu', icon: ChefHat },
...
function applyDateFilter() {
    router.get(
        '/operations-report/daily-session-menu',
...
function statusLabel(value: MenuRow['status']) {
    const labels: Record<MenuRow['status'], string> = {
        confirmed: 'Confirmed',
        invoiced: 'Invoiced',
        paid: 'Paid',
    };
...
function statusClass(value: MenuRow['status']) {
    const classes: Record<MenuRow['status'], string> = {
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-6 p-4 lg:p-6">
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Menu items sent to the kitchen route, confirmed,
                        invoiced, and paid for the POS session date.
                    </p>
                    <div
                ...
                >
                    ...
                    <div class="relative">
                        ...
                        <Input
                            v-model="search"
                            placeholder="Search kitchen order menu..."
            ...
            <MasterDataTable
                :rows="visibleRows"
                empty-text="No menu items with kitchen print route found for this POS session date."
            >
                <template #head>
                    <th
