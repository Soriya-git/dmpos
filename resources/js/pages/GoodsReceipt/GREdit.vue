...
function addAllocation(lineId: number) {
    const remaining = maxQuantityFor({
                ...
                >
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div
                                class="flex h-10 items-center rounded-lg border border-slate-200 bg-slate-50 px-3 font-mono text-sm font-bold text-slate-500"
                            >
                                {{ receipt.receipt_no }}
                            </div>
                        </div>
