...
/**
 * @see \App\Http\Controllers\Putaway\PutawayController::completedGoodsReceipts
 * @see app/Http/Controllers/Putaway/PutawayController.php:51
 * @route '/putaway/completed-goods-receipts'
 */
export const completedGoodsReceipts = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
const putaway = {
    ...
    completedGoodsReceipts: Object.assign(
