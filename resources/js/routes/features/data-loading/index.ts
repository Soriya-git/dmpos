...
const dataLoading = {
    deferredProps: Object.assign(deferredProps, deferredProps),
    partialReloads: Object.assign(partialReloads, partialReloads),
    infiniteScroll: Object.assign(infiniteScroll, infiniteScroll),
    whenVisible: Object.assign(whenVisible, whenVisible),
    polling: Object.assign(polling, polling),
    propMerging: Object.assign(propMerging, propMerging),
    onceProps: Object.assign(onceProps, onceProps),
    optionalProps: Object.assign(optionalProps, optionalProps),
};
