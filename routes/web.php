...
use App\Http\Controllers\MasterData\MenuPriceListController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/master-data/menu-price-lists', [MenuPriceListController::class, 'index'])->name('master-data.menu-price-lists');
    Route::post('/master-data/menu-price-lists', [MenuPriceListController::class, 'store'])->name('master-data.menu-price-lists.store');
    Route::patch('/master-data/menu-price-lists/{priceList}', [MenuPriceListController::class, 'update'])->name('master-data.menu-price-lists.update');
    Route::post('/master-data/menu-price-lists/prices', [MenuPriceListController::class, 'storePrice'])->name('master-data.menu-price-lists.prices.store');
    Route::patch('/master-data/menu-price-lists/prices/{price}', [MenuPriceListController::class, 'updatePrice'])->name('master-data.menu-price-lists.prices.update');
